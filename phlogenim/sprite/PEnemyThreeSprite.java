...
public class PEnemyThreeSprite extends PSprite implements Sprite {
    ...
    private static BufferedImage[] enemy_images_right
		= {new ImageLoader().loadImage("/phlogenim/images/v3R2.gif"),
		   new ImageLoader().loadImage("/phlogenim/images/v3R1.gif")};

    private static BufferedImage[] enemy_images_left
	 	= {new ImageLoader().loadImage("/phlogenim/images/v3L2.gif"),
		   new ImageLoader().loadImage("/phlogenim/images/v3L1.gif")};

    private static SoundClip shot_sound = new SoundClip("/phlogenim/sounds/high-cough.wav");
    /**
	...
	public PEnemyThreeSprite(double x,
						   double y,
				  		   double m,
				  		   Sprite hero,
				  		   boolean facing)
